//usamos singleton para exponer solo una instancia de un ad
interface Ad{
    imageUrl: string
    title:string
    body:string
...
class Ads{
    ...
    private initAds(){
        //copia intacta de los ads
        this.ads = [...ALL_ADS]
    }

    getAd(){

        //si ya me termine los ads los vuelvo a poner de 0
